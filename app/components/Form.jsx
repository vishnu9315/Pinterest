  ...
  return (
    <div className=' bg-white p-16 rounded-2xl '>
      <div className='flex justify-end mb-6'>
        <button onClick={() => onSave()} className='bg-red-500 p-2
      ...
      <div className='grid grid-cols-1 lg:grid-cols-3 gap-10'>
        ...
        border-b-[2px] border-gray-400 placeholder-gray-400'/>
            ...
            <UserTag />
            <textarea type="text"
              placeholder='Tell everyone what your pin is about' onChange={(e) => setDesc(e.target.value)}
              className=' outline-none  w-full mt-8 text-[14px]
        border-b-[2px] border-gray-400 placeholder-gray-400'/>
            <input type="text" placeholder='Add a Destination Link' onChange={(e) => setLink(e.target.value)}
              className=' outline-none pb-1 w-full mt-[90px]
        border-b-[2px] border-gray-400 placeholder-gray-400'/>
          </div>
        </div>
